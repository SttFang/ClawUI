...
// --- ChartStyle ---
// Generates scoped CSS custom properties for chart colors. Input is developer-controlled ChartConfig, not user content.
...
type TooltipPayloadItem = {
  ...
  value?: unknown;
  color?: unknown;
  payload?: Record<string, unknown> & { fill?: unknown; key?: unknown };
      ...
      <div className="grid gap-1.5">
        {payload.map((item, index) => {
          ...
          return (
            ...
            >
              {formatter && item?.value !== undefined && nameValue ? (
                formatter(item.value, nameValue, item, index, item.payload)
              ) : (
                <>
                  {itemConfig?.icon ? (
                    <itemConfig.icon />
